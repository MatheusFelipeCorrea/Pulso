...
- **Cada fase gera UM arquivo `.md` próprio** em `.github/audits/results/ux-design/` (nomes abaixo).
...
**Arquivo de saída:** `.github/audits/results/ux-design/design-fase-1-fundamentos-tokens.md`
...
**Arquivo de saída:** `.github/audits/results/ux-design/design-fase-2-componentes-padroes.md`
...
**Arquivo de saída:** `.github/audits/results/ux-design/design-fase-3-consistencia-a11y.md`
...
**Arquivo de saída:** `.github/audits/results/ux-design/design-system-guia-canonico.md`
...
**Comece agora pela FASE 1** e salve em `.github/audits/results/ux-design/design-fase-1-fundamentos-tokens.md`. Ao terminar, pare e aguarde meu "OK, próxima fase".
