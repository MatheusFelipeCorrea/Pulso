...
**Arquivo de saída:** `xx/security-fase-1-auth-authz.md`
...
**Arquivo de saída:** `xx/security-fase-2-dados-integracoes.md`
...
**Arquivo de saída:** `xx/security-fase-3-infra-lgpd.md`
...
**Arquivo de saída:** `xx/security-sumario-executivo.md`
...
**Comece agora pela FASE 1** e gere `xx/security-fase-1-auth-authz.md`. Ao terminar, pare e aguarde meu "OK, próxima fase".