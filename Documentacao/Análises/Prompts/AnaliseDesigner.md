...
**Arquivo de saída:** `xx/design-fase-1-fundamentos-tokens.md`
...
**Arquivo de saída:** `xx/design-fase-2-componentes-padroes.md`
...
**Arquivo de saída:** `xx/design-fase-3-consistencia-a11y.md`
...
**Arquivo de saída:** `xx/design-system-guia-canonico.md`
...
**Comece agora pela FASE 1** e gere `xx/design-fase-1-fundamentos-tokens.md`. Ao terminar, pare e aguarde meu "OK, próxima fase".
```
`
